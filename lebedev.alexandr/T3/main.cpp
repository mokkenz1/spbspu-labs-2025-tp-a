...
int main(int argc, char * argv[])
{
  ...
  cmds["AREA"] = std::bind(lebedev::printArea, std::ref(std::cin), std::ref(std::cout), std::cref(polygons));
  cmds["MAX"] = std::bind(lebedev::printMax, std::ref(std::cin), std::ref(std::cout), std::cref(polygons));
