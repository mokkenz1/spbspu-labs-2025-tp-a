...
void lebedev::printHelp(std::ostream& out)
{
  out << "Commands system:\n";
...
void lebedev::rewriteFile(std::istream& in, const dict_t& dicts)
{
  processWriting(in, dicts, std::ios::out);
}

void lebedev::writeToFile(std::istream& in, const dict_t& dicts)
{
  processWriting(in, dicts, std::ios::app);
}

void lebedev::createDict(std::istream& in, dict_t& dicts)
{
  std::string name;
  in >> name;
  tree_t dict;
...
void lebedev::deleteDict(std::istream& in, dict_t& dicts)
{
...
void lebedev::printDict(std::istream& in, std::ostream& out, const dict_t& dicts)
{
  std::string name;
  in >> name;
...
void lebedev::getTranslationEng(std::istream& in, std::ostream& out, const dict_t& dicts)
{
  std::string dict_name, eng_word;
...
void lebedev::getTranslationRu(std::istream& in, std::ostream& out, const dict_t& dicts)
{
...
void lebedev::deleteEng(std::istream& in, dict_t& dicts)
{
...
void lebedev::addEng(std::istream& in, dict_t& dicts)
{
  std::string dict_name, eng_word;
  size_t cnt;
...
void lebedev::deleteRu(std::istream& in, dict_t& dicts)
{
  modifyTranslations(in, dicts, false);
}

void lebedev::addRu(std::istream& in, dict_t& dicts)
{
  modifyTranslations(in, dicts, true);
}

void lebedev::makeUnion(std::istream& in, dict_t& dicts)
{
  processOperation(in, dicts, UnionOperation{ });
}

void lebedev::makeIntersect(std::istream& in, dict_t& dicts)
{
  processOperation(in, dicts, IntersectOperation{ });
}

void lebedev::makeComplement(std::istream& in, dict_t& dicts)
{
  processOperation(in, dicts, ComplementOperation{ });
}

void lebedev::printMostCommons(std::istream& in, std::ostream& out, const dict_t& dicts)
{
  int n, k;
  if (!(in >> n >> k))
  {
